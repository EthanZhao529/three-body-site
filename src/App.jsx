...
export default function App() {
  return (
    <ClickSpark sparkColor="#97c3ff" sparkRadius={22} sparkCount={8} duration={450}>
      <div className="relative min-h-screen overflow-x-hidden bg-black text-white">
        ...
        <main className="relative z-10">
          ...
          <header className="flex min-h-screen flex-col items-center justify-center gap-6 px-6 text-center">
            ...
            />
            <div className="mt-2 h-8 font-santi text-base text-[#97c3ff] md:text-lg">
              <TextType
                text={QUOTES}
                typingSpeed={80}
                deletingSpeed={30}
            ...
            <StarBorder
              ...
              className="mt-6"
            >
              <span className="block bg-[#060a14] px-10 py-4 font-santi text-lg text-white rounded-[18px] border border-[#16233f]">
                进入三体实时演算 →
              </span>
            </StarBorder>
            <a
          ...
          <footer className="border-t border-white/10 px-6 py-10 text-center">
            <p className="font-santi text-sm text-white/50">给岁月以文明,而不是给文明以岁月。</p>

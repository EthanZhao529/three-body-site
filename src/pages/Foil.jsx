...
import VanGoghCollapse from '../components/VanGoghCollapse/VanGoghCollapse';
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <VanGoghCollapse onPhase={setPhase} onReady={api => { apiRef.current = api; }} />
      </div>
      ...
      <p className="pointer-events-none absolute inset-x-0 bottom-6 z-0 hidden select-none px-8 text-center font-body text-sm text-[#C6CDDB]/45 md:block">
        {phase === 'plane'
          ? '给岁月以文明,而不是给文明以岁月 —— 太阳系的一切,都凝在了这幅永恒的星空里。'
          : '歌者随手掷来一片二向箔 —— 三维的太阳系,将被卷进一幅流动的画。'}
      </p>
    </section>
  );
}
